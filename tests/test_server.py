...
class TestServer(unittest.TestCase):
    '''
    Тестирование сервертногоо прилоожения
    '''
    err_dict = {
        RESPONSE: 400,
        ERROR: 'Bad Request'
